...
export const learningExtractionAgent = new Agent({
  ...
  instructions: ` あなたは検索結果を分析し、重要な洞察を抽出すること
の専門家です。あなたの役割は：
...
3\. 調査を深める 1 つの関連するフォローアップ質問を生成する

4\. 一般的な観察よりも、実行可能な洞察と具体的な情報に焦点を当て
る
...
\- フォローアップ質問が焦点を絞られており、より深い理解につながる
ようにする
...

{
  ...
  "followUpQuestions": [" フォローアップ質問（最大 1 つ）"]
}`,
